...
let current_users = ["Laiba", "Kinza", "Hamnah", "Hania", "Ramlah"];
let new_users = ["Anzish", "Musfira", "Kinza", "Laiba", "Sadaf"];
new_users.forEach((new_user) => {
    if (current_users.some((current_user) => current_user.toLowerCase() === new_user.toLowerCase())) {
        console.log(`${new_user} needs to choose a new username because it has already taken.`);
    }
    else {
