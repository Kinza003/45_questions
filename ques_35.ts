/* Think of at least three different animals that 
have a common characteristic. Store the names of 
these animals in a list, and then use a for loop to 
...
// printing names eith message
for (let i = 0; i < animals.length; i++) {
    console.log(`${animals[i]} is a domestic animal.`);
}
console.log("\n");

console.log(`${animals[0]}, ${animals[1]}, and ${animals[2]} meat is halal in Islam.`)